...
const int Fib2584Ai::Heuristic::positionWeight[4][4] = {
	{15, 14, 11, 7},
	{13, 12, 9, 4},
	{10, 8, 5, 2},
	{6, 3, 1, 0}
...
MoveDirection Fib2584Ai::Heuristic::operator()(int board[4][4])
{
	buildInvBoard(board);
	buildTileQueue();
...
void Fib2584Ai::Heuristic::buildTileQueue()
{
	tileQueue.clear();
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
...
void Fib2584Ai::Heuristic::buildInvBoard(int board[4][4])
{
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			int k;
...
bool Fib2584Ai::Heuristic::canMove(MoveDirection dir, int row, int col) const
{
	int i;
...
bool Fib2584Ai::Heuristic::canMerge(MoveDirection dir, int row, int col) const
{
	int i;
...
bool Fib2584Ai::Heuristic::canStrategicMove(MoveDirection dir, int row, int col) 
	const
{
	int tileCount;	
...
bool Fib2584Ai::Heuristic::recornerTest(int row, int col) 
{
...
bool Fib2584Ai::Heuristic::allCanMove(MoveDirection dir) const
{
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			if (invBoard[i][j] == 0)
...
bool Fib2584Ai::Heuristic::isRowStuck(int row) const
{
...
bool Fib2584Ai::Heuristic::isColStuck(int col) const
{
...
int Fib2584Ai::Heuristic::countNonMergeableTile(MoveDirection dir, int row, 
	int col) const
{
	int tileCount = 0;
